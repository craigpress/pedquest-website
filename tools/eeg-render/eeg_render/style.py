...
PANEL_LABELS: Dict[str, str] = {
    ...
    "alpha_delta_ratio": "Alpha/delta\nL vs R",
    "theta_delta_ratio": "Theta/delta\nL vs R",
    "theta_delta_ratio_L": "Theta/delta\nratio LEFT",
    "theta_delta_ratio_R": "Theta/delta\nratio RIGHT",
    "alpha_delta_ratio_lateral": "Alpha/delta\nlateral  L vs R",
    "alpha_delta_ratio_parasagittal": "Alpha/delta\nparasag.  L vs R",
    "theta_delta_ratio_lateral": "Theta/delta\nlateral  L vs R",
    "theta_delta_ratio_parasagittal": "Theta/delta\nparasag.  L vs R",
    "suppression_ratio": "Suppression\nratio  L vs R  (%)",
    "suppression_ratio_global": "Suppression\nratio  (%)",
    "fft_LL": "FFT  LEFT\nlateral",
    "fft_LP": "FFT  LEFT\nparasagittal",
    "fft_RP": "FFT  RIGHT\nparasagittal",
    "fft_RL": "FFT  RIGHT\nlateral",
...
PANEL_WEIGHT: Dict[str, float] = {
    ...
    "alpha_delta_ratio": 1.0,
    "theta_delta_ratio": 1.0,
    "theta_delta_ratio_L": 0.9,
    "theta_delta_ratio_R": 0.9,
    "alpha_delta_ratio_lateral": 1.0,
    "alpha_delta_ratio_parasagittal": 1.0,
    "theta_delta_ratio_lateral": 1.0,
    "theta_delta_ratio_parasagittal": 1.0,
    "suppression_ratio": 0.95,
    "suppression_ratio_global": 0.85,
    "fft_LL": 1.15,
    "fft_LP": 1.15,
    "fft_RP": 1.15,
    "fft_RL": 1.15,
